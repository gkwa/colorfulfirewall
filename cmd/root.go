...
to quickly create a Cobra application.`,
	...
	// 	fmt.Println("Hello from colorfulfirewall!")
	// },
}
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.colorfulfirewall.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".colorfulfirewall" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigType("yaml")
		viper.SetConfigName(".colorfulfirewall")
	}
